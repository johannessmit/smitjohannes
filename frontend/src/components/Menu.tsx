...
const Menu = (
    ...
    return (
        <header className={classNames(
            "flex w-100 items-center justify-between px-6 py-4 md:py-0 fixed top-0 left-0 right-0 transition-opacity duration-500 bg-gradient-to-b from-gray-900 z-40",
            {
                'opacity-0': fade
            }
        )}>
