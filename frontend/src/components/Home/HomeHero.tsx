...
const HomeHero = ({ descriptions }: HomeHeroProps) => {
    ...
    return (
        <main className="flex min-h-screen w-full items-center justify-center relative">
            <Particles
                id="tsparticles"
                init={particleInit}
                options={homeHero}
            ...
            />
            <div className="h-screen absolute z-0 top-0 bg-gradient-to-t from-black w-screen from-0% via-25% to-40%">
